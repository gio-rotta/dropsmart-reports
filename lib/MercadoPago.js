    ...
    try {
      ...
      return request.get(optionsObject)
       .then(function (parsedBody) {
          ...
          console.log(parsedBody[0].file_name);
    ...
    try {
      ...
      return request.post(optionsObject)
       .then(function (parsedBody) {
        ...
        .catch(function (err) {
          console.log('Error during report request', err);
        });
    } catch(err) {
      console.log(err);
    }
    ...
    try {
      ...
      return request.get(optionsObject)
       .then(function (parsedBody) {
        ...
        .catch(function (err) {
          console.log('Error during auto generated', err);
        });
    } catch(err) {
      console.log(err);
    }
    ...
    try {
      ...
      return request.post(optionsObject)
       .then(function (parsedBody) {
        ...
        .catch(function (err) {
          console.log('Error during setting report config', err);
        });
    } catch(err) {
      console.log(err);
    }
